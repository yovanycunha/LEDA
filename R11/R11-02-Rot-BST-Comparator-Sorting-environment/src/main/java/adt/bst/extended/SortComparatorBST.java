...
/**
 * Interface definindo uma BST que trabalha obrigatoriamente com um comparator. Dessa forma, 
 * toda e qualquer comparacao feita pela implementacao deve usar o comparator.
 * @author Adalberto
 *
 */
